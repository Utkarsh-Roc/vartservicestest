          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="inner pt--80 text-center">
                ...
                <h1 className="title display-one">App Development</h1>
                <img src='../illustrations/i9.png' />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-7">
                  <p>Our mobile application developers have deep expertise creating apps for all the major platforms including iOS (iPhone, iPad), Android, BlackBerry and Windows Mobile. Experts to help with a certain aspect of your project such as business analysis, custom UX/UI design, code development, project management and/or quality assurance, or looking for a complete end-to-end or mobile app development solution to be delivered. we can meet your needs.</p>
                </div>
