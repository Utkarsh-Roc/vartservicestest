...
function SocialMedia() {
  return (
    <>
    <SEO title="Social Media | Services | vartservices.com" />
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="inner pt--80 text-center">
                ...
                <h1 className="title display-one">Social Media</h1>
                <img src='../illustrations/i17.png' />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-7">
                  <p>V-Art Services PVT. LTD. expertise in digital strategy with innovative tools and metrics, we develop and implement innovative social media strategies for maximum business relevance and impact. We can help you build honest, engaging and meaningful conversations, encourage participation and create sustained relationships and advocacy. We help you talk with, and be talked about by your customers.</p>
                </div>
