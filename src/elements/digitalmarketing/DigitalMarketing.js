          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="inner pt--80 text-center">
                ...
                <h1 className="title display-one">Digiatal Marketing</h1>
                <img src='../illustrations/i14.png' />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-7">
                  <p>V-Art can help you develop better interactions, build better experiences and leverage customer relationships across all digital channels, through a combination of brand planning, technology, in-depth analysis and path-breaking innovation. Through measurable, actionable, and on target strategies, vector art help’s your brand where it needs to be.Our key focus areas are Digital Marketing (SEO and Paid Online Marketing), User Experience (UX) and User Interface (UI) Design.</p>
                </div>
...
export default DigiatalMarketing